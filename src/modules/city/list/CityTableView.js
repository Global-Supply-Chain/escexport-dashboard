...
export const CityTableView = () => {

    const dispatch = useDispatch();
    const { cities, paginateParams } = useSelector(state => state.city);
    ...
    const columns = useRef(cityPayload.columns);
   ...
   */
    ...
    const loadingData = useCallback(async () => {
        setLoading(true);
        const result = await cityService.index(dispatch, paginateParams);
            ...
            <div className=' flex items-center justify-content-between'>
                ...
                <div className=' flex align-items-center gap-3'>
                    <Button
                        ...
                        size="small"
                        onClick={() => {
                            dispatch(setPaginate(cityPayload.paginateParams));
